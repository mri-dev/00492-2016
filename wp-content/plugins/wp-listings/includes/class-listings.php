	...
	function __construct() {
		...
		$this->property_details = apply_filters( 'wp_listings_property_details', array(
		    ...
		    __( 'Építés éve', 'ti' )  => '_listing_year_built',
				__( 'Szintek száma', 'ti' )  => '_listing_level_numbers',
				__( 'Szobák száma', 'ti' )  => '_listing_room_numbers',
				__( 'Telek alapterület (nm)', 'ti' )  => '_listing_lot_size',
				__( 'Ingatlan alapterület (nm)', 'ti' )  => '_listing_property_size',
				__( 'Fürdőszobák száma', 'ti' )  => '_listing_bathroom_numbers',
			),
			'checkbox' => array(
				__( 'Garázs', 'ti' )  => '_listing_garage',
